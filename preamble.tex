...
\newcommand{\gitinfonote}{%
	\texttt{\footnotesize%
		\textcolor{gitaccent}{\normalfont}\,%
		\href{https://github.com/sohamch08/lumina}{%
			\textcolor{mytheoremfr!80!white}{\faGithub\,\texttt{\textup{sohamch08/lumina}}}%
		}%
		\;\gitsep\;%
...
\newcommand{\lemc}[3][]{\begin{Lemma}{#2}{#1}#3\end{Lemma}}
\newcommand{\clm}[3][]{\begin{claim}{#2}{#1}#3\end{claim}}
\newcommand{\clmc}[3][]{\begin{Claim}{#2}{#1}#3\end{Claim}}
