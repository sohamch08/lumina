...
\newcommand{\thmref}[2][]{\hyperref[th:#2]{Theorem~\ref{th:#2}#1}}
\newcommand{\propref}[2][]{\hyperref[th:#2]{Proposition~\ref{th:#2}#1}}
\newcommand{\lmref}[2][]{\hyperref[th:#2]{Lemma~\ref{th:#2}#1}}
\newcommand{\corref}[2][]{\hyperref[th:#2]{Corollary~\ref{th:#2}#1}}
\newcommand{\obsref}[2][]{\hyperref[#2]{Observation~\ref{#2}#1}}
\newcommand{\defref}[2][]{\hyperref[def:#2]{Definition~\ref{def:#2}#1}}
